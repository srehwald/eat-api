...
class MedizinerMensaParserTest(unittest.TestCase):
    ...
    dish4_mon2 = Dish("Thai-Curry aus Blumenkohl und Kartoffeln mit Gemüsreis und Salat", 2.2, set(["Sw", "So", "Gl", "Mi"]))
    ...
    dish4_tue2 = Dish("Rotbarschfischfilet in Dillsoße mit Kürbisgemüse und Wacholderreis", 3.65, set(["Mi", "Gl", "Fi"]))
    ...
    dish4_wed2 = Dish("Schinkennudeln mit Tomatensoße, dazu gemischter Salat", 2.1, set(["Gl", "Mi", "Sf", "Sw", "2", "3", "8", "G"]))
    ...
    dish4_thu2 = Dish("Pikantes Risotto mit buntem Gemüse und Tomatensalat mit Basilikum", 2.15, set(["Mi", "1", "2", "Sw"]))
    ...
    dish4_fri2 = Dish("Paniertes Schnitzel vom Schwein und Pute mit Kartoffelmayosalat und Zitronenecke", 3.6, set(["Gl", "Ei", "Sf", "4", "3", "G", "S"]))
