...
class StudentenwerkMenuParserTest(unittest.TestCase):
    ...
    dish1_2_garching = Dish("Hackfleischbällchen mit Champignonrahmsauce", 1.9, set(["R", "S", "Ei", "Gl", "GlW", "Kn", "Mi"]))
    dish1_3_garching = Dish("Seelachsfilet (MSC) im Sesammantel mit Remouladensauce", 2.4, set(["1", "2", "3", "9", "Ei", "Fi", "Gl", "GlW", "Mi", "Se", "Sf"]))
    dish1_4_garching = Dish("Gebackene Calamari-Ringe mit Remouladensauce", 2.6, set(["1", "2", "3", "9", "Ei", "Gl", "GlW", "Mi", "Sf", "Wt"]))
    ...
    dish1_2_arcisstrasse = Dish("Hackfleischbällchen mit Champignonrahmsauce", 1.55, set(["R", "S", "Ei", "Gl", "GlW", "Kn", "Mi"]))
    dish1_3_arcisstrasse = Dish("Hackfleischbällchen mit Champignonrahmsauce (2)", 1.9, set(["R", "S", "Ei", "Gl", "GlW", "Kn", "Mi"]))
    dish1_4_arcisstrasse = Dish("Pasta Pomodori", 1.9, set(["Gl", "GlW", "Kn"]))
    dish1_5_arcisstrasse = Dish("Gebackene Calamari-Ringe mit Zitronen-Knoblauch-Dip", 2.6, set(["1", "2", "3", "9", "Ei", "Gl", "GlW", "Kn", "Mi", "Sf", "Wt"]))
    dish1_6_arcisstrasse = Dish("Seelachsfilet (MSC) im Sesammantel mit Zitronen-Knoblauch-Dip", 2.6, set(["1", "3", "9", "Ei", "Fi", "Gl", "GlW", "Kn", "Mi", "Se", "Sf"]))
    ...
    dish1_2_großhadern = Dish("Rinderroulade nach Hausfrauenart mit Senf-Gemüse-Sauce", 3, set(["R", "S", "2", "3", "99", "Gl", "GlG", "GlW", "Kn", "Mi", "Sf", "Sl", "Sw"]))
    ...
    def test_Should_ReturnMenu_When_PassedDateIsCorrect(self):
        self.assertEqual(self.menu1_garching,
                         self.studentenwerk_menu_parser.get_menus(self.menu_html_garching, "mensa-garching")[self.menu1_date])
        self.assertEqual(self.menu2_garching,
                         self.studentenwerk_menu_parser.get_menus(self.menu_html_garching, "mensa-garching")[self.menu2_date])

        self.assertEqual(self.menu1_arcisstrasse,
                         self.studentenwerk_menu_parser.get_menus(self.menu_html_arcisstrasse, "mensa-arcisstrasse")[self.menu1_date])

        self.assertEqual(self.menu1_großhadern,
                         self.studentenwerk_menu_parser.get_menus(self.menu_html_großhadern, "stubistro-grosshadern")[self.menu3_date])
...
class FMIBistroParserTest(unittest.TestCase):
    ...
    dish_aktion1 = Dish("Tellerfleisch mit Bouillonkartoffeln und Sahnemeerrettich Kaiserschmarrn mit Zwetschenröster",
                        3.0, set())
    dish1_mon1 = Dish("Kurkumareis mit Asia Wokgemüse", 3.6, set())
    dish2_mon1 = Dish("Kartoffel „Cordon Bleu“ mit Frischkäse gefüllt dazu Blattsalate", 4.3, set())
    dish3_mon1 = Dish("Putenschnitzel natur mit Paprikarahmsoße dazu Ebly Gemüseweizen", 5.3, set())
    dish1_thu1 = Dish("Süßkartoffel Gemüsepfanne", 3.6, set())
    dish2_thu1 = Dish("Gemüse Nudelauflauf", 4.3, set())
    dish3_thu1 = Dish("Hähnchenspieß in Kokos Currysoße dazu Früchtereis", 5.3, set())
    dish1_fri1 = Dish("Antipasti Rosmarinkartoffeln", 3.6, set())
    dish2_fri1 = Dish("Schlemmerfilet auf Antipasti Rosmarinkartoffeln", 4.5, set())
    dish3_fri1 = Dish("Kaiserschmarrn mit Zwetschenröster", 3, set())
    ...
    dish_aktion2 = Dish("Pochiertes Lachsfilet mit Dillsoße dazu Minze-Reis", 6.5, set())
    dish1_mon2 = Dish("Dampfkartoffeln mit Zucchinigemüse", 3.6, set())
    dish2_mon2 = Dish("Valess-Schnitzel mit Tomaten-Couscous", 4.3, set())
    dish3_mon2 = Dish("Kasslerpfanne mit frischen Champignons und Spätzle", 4.9, set())
    dish1_tue2 = Dish("Gemüsereispfanne mit geräuchertem Tofu", 3.6, set())
    dish2_tue2 = Dish("Schweineschnitzel in Karottenpanade mit Rosmarin- Risoleekartoffeln", 5.3, set())
    dish1_wed2 = Dish("Spaghetti al Pomodoro", 3.6, set())
    dish2_wed2 = Dish("Krustenbraten vom Schwein mit Kartoffelknödel und Krautsalat", 5.3, set())
    dish1_thu2 = Dish("Red-Thaicurrysuppe mit Gemüse und Kokosmilch", 2.9, set())
    dish2_thu2 = Dish("Senf-Eier mit Salzkartoffeln", 3.8, set())
    dish3_thu2 = Dish("Putengyros mit Zaziki und Tomatenreis", 5.3, set())
    dish1_fri2 = Dish("Spiralnudeln mit Ratatouillegemüse", 3.6, set())
    dish2_fri2 = Dish("Milchreis mit warmen Sauerkirschen", 3, set())
    dish3_fri2 = Dish("Lasagne aus Seelachs und Blattspinat", 5.3, set())
...
class IPPBistroParserTest(unittest.TestCase):
    ...
    dish1_mon1 = Dish("Gefüllter Germknödel mit Vanillesauce", 3.5, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"]))
    dish2_mon1 = Dish("Ofengulasch vom Rind mit Kürbis und Pflaumen, dazu Rigatoni", 5.5, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"]))
    dish3_mon1 = Dish("\"Palek Tofu\" Gebratener Tofu mit Spinat, Ingwer, Curry-Sahnesauce und Basmatireis", 5.2, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"]))
    dish4_mon1 = Dish("Gebratene Hähnchenbrust auf Fenchelgemüse, dazu Kräuterreis und Orangensauce", 6.9, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"]))
    dish1_tue1 = Dish("Gebratene Weißkohl-Kartoffelpfanne mit gerösteten Sonnenblumenkernen", 3.5, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"]))
    dish2_tue1 = Dish("Jägerschnitzel mit Spätzle oder Reis", 4.8, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"]))
    dish3_tue1 = Dish("Vegetarisch gefüllte Tortelli mit leichter Zitronen-Buttersauce und gehobeltem Parmesan", 4.8, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"]))
    ...
    dish4_thu1 = Dish("\"Lamm Palak\" mit Spinat und Curry (mittelscharf), dazu Reis", 6.9, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"]))
    dish1_fri1 = Dish("Nudelpfanne mit Gemüsesauce (auf Wunsch mit Reibekäse)", 3.5, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"]))
    dish2_fri1 = Dish("Matjes \"Hausfrauen Art\" mit Salzkartoffeln", 5.2, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"]))
    dish3_fri1 = Dish("Currygeschnetzeltes von der Pute mit Früchten und Reis", 4.9, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"]))
    dish4_fri1 = Dish("Honig-Kassler mit Apfel-Spitzkohl und Kartoffelspalten", 6.2, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"]))
    ...
    dish2_tue2 = Dish("Krautwickerl mit Speck-Zwieblsauce und Püree", 4.5, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"]))
    dish3_tue2 = Dish("Rigatoni mit Rosenkohl und Schnittlauch", 4.6, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"]))
    dish4_tue2 = Dish("Spanferkelrücken mit Knödel und Bayerisch Kraut", 6.8, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"]))
    dish1_wed2 = Dish("Weißwurst Gröst ́l mit Knödel, Lauchzwiebeln, Karotten und Kräuter auf Wunsch mit "
                      "Bratenjus", 3.5, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"]))
    dish2_wed2 = Dish("Estragonrahmschnitzel mit Pommes frites oder Reis", 4.6, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"]))
    dish3_wed2 = Dish("Gemüse Lasagne", 4.9, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"]))
    dish4_wed2 = Dish("\"Tandoori Chicken\" mit Auberginen, Tomaten, Zucchini, Zitronenschale Minze und Reis", 6.9, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"]))
    dish1_thu2 = Dish("Rote Beete Eintopf mit Kartoffeln, Nudeln und Dill", 3.5, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"]))
    dish2_thu2 = Dish("Sauerbraten \"Nepal\" mit weißen Bohnen, getrockneten Tomaten und Pasta", 5.8, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"]))
    dish3_thu2 = Dish("\"Kaku Chicken\" mit geröstetem Curry, Kokosraspel, Tomaten und Reis", 6.9, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"]))
    dish4_thu2 = Dish("Leberkäs Burger special mit Pommes frites und Cole slaw", 4.8, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"]))
    dish1_fri2 = Dish("Exotische Linsen-Spätzle Pfanne", 3.5, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"]))
    dish2_fri2 = Dish("Seelachsfilet gebacken mit Sardellenmayonnaise und Pommes frites", 4.6, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"]))
    dish3_fri2 = Dish("Gemüse-Linguini mit Pesto-Rahmsauce und Parmesankäse", 4.4, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"]))
    dish4_fri2 = Dish("Schweinefilet Medaillons in grüner Pfefferrahmsauce mit Kroketten und karamellisierten "
                      "Möhren", 7.2, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"]))
    ...
    y18w18_dishes_wed = [
        Dish("Kirschmichel mit Vanillesauce", 3.5, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"])),
        Dish("Fitnessteak vom Grill, dazu Zitrone oder Kräuterbutter, Grilltomate und Ofenkartoffel mit "
             "Sauerrahmdip oder bunter Salatauswahl", 8.2, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"])),
        Dish("\"Chana Dal\" Kichererbsen, Kartoffeln, Kokosmilch, Curryblätter und Reis", 4.9, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"])),
        Dish("Calamari alla Romana, gebackene Tintenfischringe mit Knoblauchmayonnaise und "
             "gemischtem Blattsalat mit Tomate und Gurke", 6.2, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"]))
    ]

    y18w18_dishes_thu = [
        Dish("Grenaillekartoffeln mit Apfel-Möhren-Quark, auf Wunsch mit gerösteten Sonnenblumenkernen", 3.5, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"])),
        Dish("Böfflamott, gebeizter Rinderschmorbraten mit Rotwein, dazu Frühlingsgemüse und Semmelknödel", 6.8, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"])),
        Dish("Fussili mit Lauch, Ricotta, Meerrettich und frischem Basilikum", 4.5, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"])),
        Dish("Aus dem Wok Putengeschnetzeltes mit Mangold, Möhren, Frühlings- zwiebeln und Basmatireis", 6.9, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"]))]

    y18w18_dishes_fri = [
        Dish("Curryreispfanne mit Gemüse, Ananas, Kreuzkümmel, Koriander und Chili-Dip", 3.5, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"])),
        Dish("Zitronen Seelachs auf Paprika-Champignon Gemüse, Petersilien- Kartoffeln und leichter Buttersauce", 5.90, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"])),
        Dish("Paprikarahmgeschnetzeltes mit Hörnchennudeln", 5.2, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"])),
        Dish("\"Pasta Arora\" italienische Nudeln mit Tomatensahne, Mozzarella und Basilikum", 4.5, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"]))]
    ...
    y18w19_dishes_mon = [
        Dish("Gemüse-Schupfnudeln dazu Sauerrahm-Dip", 3.5, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"])),
        Dish("Würziger Putenbrustbraten mit Frühlingsgemüse und Kroketten", 7.2, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"])),
        Dish("Gnocchi-Lauch Gratin mit Käse überbacken", 4.8, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"])),
        Dish("Schweinefleisch süß-sauer mit Ananas, Paprika, Tomaten und Reis", 6.9, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"]))]

    y18w19_dishes_tue = [
        Dish("Gebackener Edamer mit Rohkostsalat und Preiselbeeren", 4.9, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"])),
        Dish("Köttbullar (Hackfleischbällchen) mit Rahmsauce, Preiselbeeren und Petersilienkartoffeln", 4.8, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"])),
        Dish("Burgunderbraten vom Rind mit Knödel und Blaukraut", 6.2, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"])),
        Dish("Quarkknödel auf Erdbeer-Rhabarber Kompott", 3.5, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"]))]

    y18w19_dishes_wed = [
        Dish("Italienische Minestrone mit Reis", 3.5, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"])),
        Dish("Gebackenes Schweineschnitzel mit Zitrone und Pommes frites", 5.9, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"])),
        Dish("\"Vegetarian Vindaloo\" Kartoffeln und Tomaten in Currysauce, dazu Reis und frischer Koriander", 4.9, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"])),
        # Note the " after the Basilikum is correct since it is part of the PDF
        Dish("Farfalle \"al Tonno\" mit Thunfisch, Kapern, Oliven, Tomaten und Basilikum\"", 4.9, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"]))]

    y18w19_dishes_fri = [
        Dish("Spaghetti mit Tomatensauce und Reibekäse", 3.5, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"])),
        Dish("2 Paar Schweinswürst ́l auf Sauerkraut und Püree", 4.8, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"])),
        Dish("\"Chicken Padam Pasanda\" mit Nusssauce, Kokos- flocken und indischen Gewürzen, dazu Basmatireis", 6.9, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"])),
        Dish("Kartoffeltasche, gefüllt mit Kräuterfrischkäse auf Paprikagemüse", 4.9, set(["Mi", "Gl", "Sf", "Sl", "Ei", "Se", "4"]))]
...
class MedizinerMensaParserTest(unittest.TestCase):
    ...
    dish1_mon1 = Dish("Spinatcremesuppe", "N/A", set())
    dish2_mon1 = Dish("Gekochtes Ochsenfleisch mit Meerrettich", "N/A", set())
    dish3_mon1 = Dish("Kürbisauflauf", "N/A", set())
    dish4_mon1 = Dish("Asiatische Gemüse-Puten-Pfanne mit Reisnudeln", "N/A", set())

    dish1_tue1 = Dish("Selleriecremesuppe", "N/A", set())
    dish2_tue1 = Dish("Oldenburger Grünkohl mit Mettenden", "N/A", set())
    dish3_tue1 = Dish("Kaschmir Kohlrabi und Brokkoli", "N/A", set())
    dish4_tue1 = Dish("Conchiglioni Nudeln mit mit mediterranem Gemüse", "N/A", set())

    dish1_wed1 = Dish("Französische Zwiebelsuppe", "N/A", set())
    dish2_wed1 = Dish("Germknödel mit Vanillesoße", "N/A", set())
    dish3_wed1 = Dish("Herzhaftes Kartoffelgratin", "N/A", set())
    dish4_wed1 = Dish("Holzfällersteak mit Bratkartoffeln und Weißkrautsalat", "N/A", set())

    dish1_thu1 = Dish("Süßkartoffelcremesuppe", "N/A", set())
    dish2_thu1 = Dish("Hähnchenbrust gegrillt", "N/A", set())
    dish3_thu1 = Dish("In Sesamöl gebratenes Wokgemüse", "N/A", set())

    dish1_fri1 = Dish("Brokkolicremesuppe", "N/A", set())
    dish2_fri1 = Dish("Forelle \"Müllerin Art \"", "N/A", set())
    dish3_fri1 = Dish("Quarkklößchen", "N/A", set())
    dish4_fri1 = Dish("Chili con Cous Cous mit Kürbis-Apfel-Salat", "N/A", set())

    dish1_sat1 = Dish("Bratspätzlesuppe", "N/A", set())
    dish2_sat1 = Dish("Geflügelpflanzerl", "N/A", set())
    dish3_sat1 = Dish("Krauttopf mit einer Vollkornsemmel", "N/A", set())

    dish1_sun1 = Dish("Käsecremesuppe", "N/A", set())
    dish2_sun1 = Dish("Geschmortes Kalbfleisch", "N/A", set())
    dish3_sun1 = Dish("Vegetarische Moussaka", "N/A", set())
    ...
    dish1_mon2 = Dish("Blumenkohlcremesuppe", "N/A", set())
    dish2_mon2 = Dish("Pfannengyros mit Tzaziki", "N/A", set())
    dish3_mon2 = Dish("Spaghetti \" Gemüsebolognese \"", "N/A", set())
    dish4_mon2 = Dish("Thai-Curry aus Blumenkohl und Kartoffeln mit Gemüsreis und Salat", "N/A", set())

    dish1_tue2 = Dish("Gelbe Erbsensuppe", "N/A", set())
    dish2_tue2 = Dish("Grüner Bohneneintopf mit Rindfleisch", "N/A", set())
    dish3_tue2 = Dish("Veggi-Gulasch", "N/A", set())
    dish4_tue2 = Dish("Rotbarschfischfilet in Dillsoße mit Kürbisgemüse und Wacholderreis", "N/A", set())

    dish1_wed2 = Dish("Rinderbrühe \" Gärtnerin \"", "N/A", set())
    dish2_wed2 = Dish("Schweinegulasch", "N/A", set())
    dish3_wed2 = Dish("Gemüsekuchen mit Mozzarella überbacken", "N/A", set())
    dish4_wed2 = Dish("Schinkennudeln mit Tomatensoße, dazu gemischter Salat", "N/A", set())

    dish1_thu2 = Dish("Kürbiscremesuppe", "N/A", set())
    dish2_thu2 = Dish("Rinderhackbraten", "N/A", set())
    dish3_thu2 = Dish("Dinkel-Kräuterbratling", "N/A", set())
    dish4_thu2 = Dish("Pikantes Risotto mit buntem Gemüse und Tomatensalat mit Basilikum", "N/A", set())

    dish1_fri2 = Dish("Minestrone", "N/A", set())
    dish2_fri2 = Dish("Gebratene Hähnchenbrust", "N/A", set())
    dish3_fri2 = Dish("Scheiterhaufen  mit Apfel-Vanille-Ragout", "N/A", set())
    dish4_fri2 = Dish("Paniertes Schnitzel vom Schwein und Pute mit Kartoffelmayosalat und Zitronenecke", "N/A", set())

    dish1_sat2 = Dish("Tomatencremesuppe", "N/A", set())
    dish2_sat2 = Dish("Pichelsteiner Gemüseeintopf mit Rindfleisch", "N/A", set())
    dish3_sat2 = Dish("Ofenkartoffel mit herzhaftem Gemüseragout", "N/A", set())

    dish1_sun2 = Dish("Grießnockerlsuppe", "N/A", set())
    dish2_sun2 = Dish("Glasierter Putenbraten in Kräuterrahmsoße", "N/A", set())
    dish3_sun2 = Dish("Eieromelett", "N/A", set())
